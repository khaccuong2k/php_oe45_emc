        ...
        item.unbind('click').on(
            ...
            function () {
                ...
                if (a.attr("data-option") == "off") {
                    a.parent("li").children("ul").slideDown(
                        options.Speed,
                        function () {
...
function CopyToClipboard(value, showNotification, notificationText)
{
    ...
    if (showNotification && notificationTag.length == 0) {
        ...
        notificationTag.fadeIn(
            "slow",
            function () {
                setTimeout(
                    function () {
                        notificationTag.fadeOut(
                            "slow",
                            function () {

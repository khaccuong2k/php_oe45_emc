        ...
        <div class="col-lg-8 order-lg-1">
          <form class="js-validate" action="{{ route('client.order.handle') }}" method="POST">
            ...
            <div class="mb-7">
              <!-- Title -->
              <div class="mb-4">
                <h2 class="h3">{{ trans('message.payment_method') }}</h2>
              </div>
              <!-- End Title -->
              <!-- Input -->
            ...
            <a class="font-weight-bold" href="cart.html"><i class="fas fa-angle-left fa-xs mr-1"></i> {{ trans('message.return_to_cart')}}</a>
            <button type="submit" class="btn btn-primary btn-pill transition-3d-hover">{{ trans('message.place_order') }}</button>
            </div>
            <!-- End Button -->
            </div>
        <!-- End Payment -->

					...
					<div class="dropdown-menu dropdown-menu-right">
						<div class="notification-list mx-h-350 customscroll">
							<ul>
								...
								<li>
									<a href="#">
										<img src="{{ asset('admin-page/vendors/images/photo2.jpg') }}" alt="">
								...
								<li>
									<a href="#">
										<img src="{{ asset('admin-page/vendors/images/photo3.jpg') }}" alt="">
										<h3>John Doe</h3>
										<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed...</p>
									</a>
								</li>
								<li>
									<a href="#">
										<img src="{{ asset('admin-page/vendors/images/photo4.jpg') }}" alt="">
				...
				<ul id="accordion-menu">
					...
					<li class="dropdown">
						<a href="javascript:;" class="dropdown-toggle">
							<span class="micon dw dw-edit2"></span><span class="mtext">Manage Products</span>
						</a>
						<ul class="submenu">

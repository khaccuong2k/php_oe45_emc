...
@section('title')
<title>@lang('lable.title.suggest.detail')</title>
@endsection
...
@section('bread-crumb')
<li class="breadcrumb-item"><a href="{{ route('suggests.index') }}">@lang('lable.title.suggest.index')</a></li>
<li class="breadcrumb-item active">@lang('lable.title.suggest.detail')</li>
@endsection
...
<div class="card-box mb-30">
    <div class="pd-20">
        <h4 class="text-blue h4">@lang('lable.title.suggest.detail')</h4>
    </div>
    <div class="pb-20">
